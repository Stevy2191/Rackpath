...
export const RACK_CATALOG = [
  ...
  // ─── GENERIC / POWER ────────────────────────────────────────────────────────
  e('gen-pdu-1u',      'PDU 1U',      'Generic', 'POWER', 1, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 8, outletType: 'C13', inputVoltage: '120V' }),
  e('gen-pdu-2u',      'PDU 2U',      'Generic', 'POWER', 2, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 16, outletType: 'C13', inputVoltage: '208V' }),
  e('gen-ups-2u',      'UPS 2U',      'Generic', 'POWER', 2, 'ups', { outletCount: 6, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('gen-ups-4u',      'UPS 4U',      'Generic', 'POWER', 4, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '208V' }),
  e('gen-mini-ups-1u', 'Mini UPS 1U', 'Generic', 'POWER', 1, 'ups', { halfWidth: true, halfDepth: true, outletCount: 4, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  ...
  // ─── APC ─────────────────────────────────────────────────────────────────────
  e('apc-su1000-2u',   'Smart-UPS 1000VA',      'APC', 'POWER', 2, 'ups', { outletCount: 6, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('apc-su1500-2u',   'Smart-UPS 1500VA',      'APC', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('apc-su2200-2u',   'Smart-UPS 2200VA',      'APC', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('apc-su3000-2u',   'Smart-UPS 3000VA',      'APC', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '208V' }),
  e('apc-srt5000-3u',  'Smart-UPS SRT 5000VA',  'APC', 'POWER', 3, 'ups', { outletCount: 6, outletType: 'C13', inputVoltage: '208V' }),
  e('apc-srt8000-4u',  'Smart-UPS SRT 8000VA',  'APC', 'POWER', 4, 'ups', { outletCount: 8, outletType: 'C13', inputVoltage: '208V' }),
  e('apc-srt10000-6u', 'Smart-UPS SRT 10000VA', 'APC', 'POWER', 6, 'ups', { outletCount: 8, outletType: 'C19', inputVoltage: '240V' }),
  e('apc-pdu-7920',    'Rack PDU AP7920B',       'APC', 'POWER', 1, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 8, outletType: 'C13', inputVoltage: '120V' }),
  e('apc-pdu-7921',    'Rack PDU AP7921B',       'APC', 'POWER', 1, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 8, outletType: 'C13', inputVoltage: '120V' }),
  e('apc-pdu-7922',    'Rack PDU AP7922B',       'APC', 'POWER', 1, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 16, outletType: 'C13', inputVoltage: '120V' }),
  e('apc-pdu-7853',    'Metered PDU AP7853',     'APC', 'POWER', 1, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 24, outletType: 'C13', inputVoltage: '208V' }),

  // ─── CYBERPOWER ──────────────────────────────────────────────────────────────
  e('cp-or1000-1u', 'OR1000LCDRT1U',  'CyberPower', 'POWER', 1, 'ups', { outletCount: 6, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('cp-or1500-2u', 'OR1500LCDRT2U',  'CyberPower', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('cp-or2200-2u', 'OR2200LCDRT2U',  'CyberPower', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('cp-or3000-2u', 'OR3000LCDRT2U',  'CyberPower', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '208V' }),
  e('cp-pdu-15b',   'PDU15B2F12R',    'CyberPower', 'POWER', 1, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 12, outletType: 'C13', inputVoltage: '120V' }),
  e('cp-pdu-20b',   'PDU20B2F20R',    'CyberPower', 'POWER', 1, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 20, outletType: 'C13', inputVoltage: '120V' }),

  // ─── EATON ───────────────────────────────────────────────────────────────────
  e('ea-5px-1000-1u',  '5PX 1000VA',         'Eaton', 'POWER', 1, 'ups', { outletCount: 4, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('ea-5px-1500-2u',  '5PX 1500VA',         'Eaton', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('ea-5px-2200-2u',  '5PX 2200VA',         'Eaton', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '120V' }),
  e('ea-5px-3000-2u',  '5PX 3000VA',         'Eaton', 'POWER', 2, 'ups', { outletCount: 8, outletType: 'NEMA 5-15R', inputVoltage: '208V' }),
  e('ea-9px-2000rt-2u', '9PX2000RT',          'Eaton', 'POWER', 2, 'ups', { outletCount: 6, outletType: 'C13', inputVoltage: '208V' }),
  e('ea-9px-5ktf5g2-6u',    '9PX5KTF5G2',        'Eaton', 'POWER', 6, 'ups', { outletCount: 6, outletType: 'C13', inputVoltage: '208V' }),
  ...
  e('ea-9px-5000-3u',      '9PX 5000VA',         'Eaton', 'POWER', 3, 'ups', { outletCount: 6, outletType: 'C13', inputVoltage: '208V' }),
  e('ea-9px-8000-4u',      '9PX 8000VA',         'Eaton', 'POWER', 4, 'ups', { outletCount: 8, outletType: 'C13', inputVoltage: '208V' }),
  e('ea-epdu-1u',      'ePDU G3 Metered 1U', 'Eaton', 'POWER', 1, 'pdu', { halfDepth: true, mountedFace: 'rear', outletCount: 16, outletType: 'C13', inputVoltage: '208V' }),
...
export function pduCatalogEntries() {
  return RACK_CATALOG.filter((entry) => entry.renderType === 'pdu');
}
